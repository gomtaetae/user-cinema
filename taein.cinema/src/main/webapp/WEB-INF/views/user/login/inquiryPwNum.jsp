...
$ComTimer.prototype = {
    ...
    , fnTimer : function(){
        ...
        $("#time").html("&nbsp;&nbsp;"+m);
        sessionStorage.setItem('comSecond', m);
        if(this.comSecond <0){
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="close" data-dismiss="modal" onclick="location.href='/inquiryPw'">확인</button>
            </div>
        </div>
    </div>
</div>
<script>
$(function(){
	$("#inquiryPwOk").bind("click",function(){
		$.ajax({
			url:"inquiryPwOk",
			method:"get",
			data:{
			...
			success:function(result){
				if(result.is === true){
					$("#all").empty();
					$("#all").append("<h4>귀하의 아이디는 "+result.userPw+"입니다.</h4><br>" +
...
<button type="button" class="btn btn-default" id="inquiryPwOk">확인</button>
<br>
<hr>
<a href ="/logOut">로그인 하러가기</a> |	
